...
const styles = {
  ...
  avatarContainer: { marginBottom: "24px", display: "flex", justifyContent: "center", alignItems: "center", position: "relative", zIndex: 2 },
  avatarFrame: { width: "180px", height: "180px", borderRadius: "50%", background: "linear-gradient(135deg, #153C30 0%, #2D7A5F 100%)", padding: "8px", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 8px 32px rgba(21, 60, 48, 0.2), 0 0 0 4px rgba(255, 255, 255, 0.1)", animation: "float 3s ease-in-out infinite" },
